**1. Các hệ thống lưu trữ**

1.1 Hệ thống dựa trên cơ chế block storage
...
- LUN (Logical Unit Number) là 1 identifier được cấp cho các đĩa ở hệ thống lưu trữ, nó sẽ được xác định trong storage controller và phân vùng để host servers có thể truy cập vào. 1 máy tính có thể sử dụng các LUNS này để chứa dữ liệu. 1 volume là 1 phần của LUN được tạo ra với volume management software
...
2. So sánh Công nghệ Hard Disk và SSD
