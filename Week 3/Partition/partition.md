...
MBR – Master Boot Record. Phần code nhỏ chịu trách nhiệm load hệ điều hành trên máy tính. MBR còn chứa thông tin phân vùng và cách mà chúng được phân bố. Master boot record code sẽ được lưu trữ trong sector đầu tiên trên ổ cứng (sector 0) - sector này sẽ không thuộc phân vùng nào
...
1.3. Sự khác nhau giữa MBR và GPT
...
- Trong nhiều trường hợp, MBR format không thể quản lý storage lớn hơn 2TB trong khi GPT thì không giới hạn về dung lượng storage quản lý
